...
export default function Navbar() {
  return <header className="sticky top-0 z-50 border-b border-black/[.06] bg-[#f8f6ff]/85 backdrop-blur-xl"><div className="page-shell flex h-20 items-center justify-between">
    ...
    <nav className="hidden items-center gap-8 text-sm font-semibold md:flex" aria-label="Main navigation"><Link className="hover:text-[#7557ff]" href="/social-packs">Social packs</Link><Link className="hover:text-[#7557ff]" href="#how-it-works">How it works</Link><Link className="hover:text-[#7557ff]" href="#features">Features</Link></nav>
